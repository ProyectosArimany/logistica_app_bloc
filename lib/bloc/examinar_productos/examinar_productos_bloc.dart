...
part 'examinar_productos_event.dart';
part 'examinar_productos_state.dart';

class ExaminarProductosBloc
    extends Bloc<ContarProductosEvent, ExaminarProductosState> {
  final ProductosRepository productosRepository;
  final ConteosRepository conteosRespository;

  ExaminarProductosBloc(
      {required this.productosRepository, required this.conteosRespository})
      : super(ExaminarProductosInitialState()) {
